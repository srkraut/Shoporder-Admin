...
// ESEWA Payment
Route::post('pay-esewa', 'EsewaPaymentController@payWithEsewa')->name('pay-esewa');
Route::get('pay-esewa/success/{order_id}/{transaction_ref}', 'EsewaPaymentController@success')->name('pay-esewa.success');
Route::get('pay-esewa/fail', 'EsewaPaymentController@fail')->name('pay-esewa.fail');

// Khalti Payment
Route::post('pay-khalti', 'KhaltiPaymentController@payWithKhalti')->name('pay-khalti');
Route::get('pay-khalti/callback/{order_id}', 'KhaltiPaymentController@callback')->name('pay-khalti.callback');
...
Route::get('payment-fail/{message?}', 'PaymentController@fail')->name('payment-fail');
