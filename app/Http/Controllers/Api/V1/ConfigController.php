...
class ConfigController extends Controller
{
    ...
    public function configuration()
    {
        ...
        $key = [
            'cash_on_delivery', 'digital_payment','qr_payment', 'default_location', 'free_delivery_over', 
            'business_name', 'logo', 'address', 'phone', 'email_address', 'country', 'currency_symbol_position', 'app_minimum_version_android',
            'app_url_android', 'app_minimum_version_ios', 'app_url_ios', 'customer_verification', 
            'order_delivery_verification', 'terms_and_conditions', 'privacy_policy', 'about_us', 'per_km_shipping_charge', 'minimum_shipping_charge',
            'maintenance_mode', 'popular_food', 'popular_restaurant', 'new_restaurant', 'most_reviewed_foods', 
            'show_dm_earning', 'canceled_by_deliveryman', 'canceled_by_restaurant', 'timeformat', 'toggle_veg_non_veg', 
            'toggle_dm_registration', 'toggle_restaurant_registration', 'schedule_order_slot_duration',
            'loyalty_point_exchange_rate', 'loyalty_point_item_purchase_point', 'loyalty_point_status', 'loyalty_point_minimum_point', 
            'wallet_status', 'schedule_order', 'dm_tips_status', 'ref_earning_status', 'ref_earning_exchange_rate', 'theme', 'social_login'
        ];
        ...
        $qr_payment = json_decode($settings['qr_payment'], true);
        ...
        return response()->json([
            ...
            'qr_payment' => (bool)($qr_payment['status']==1?true:false),
            ...
            'social_login' =>json_decode($settings['social_login'])
        ]);
    }
