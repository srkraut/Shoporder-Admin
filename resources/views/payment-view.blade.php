                ...
                <div class="row">
                    ...
                    @if($config && $config['status'])
                        <div class="col-md-6 mb-4 cursor-pointer">
                            <div class="card" onclick="$('#esewa-form').submit()">
                                <div class="card-body pt-2 h-70px">
                                    <form action="{{ route('pay-esewa',request()->getQueryString()) }}" method="POST" class="needs-validation" id="esewa-form">
                                        @csrf
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="100"
                                                 src="{{asset('public/assets/admin/img/esewa.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
                    ...
                    @if($config && $config['status'])
                        <div class="col-md-6 mb-4 cursor-pointer">
                            <div class="card" onclick="$('#khalti-form').submit()">
                                <div class="card-body pt-2 h-70px">
                                    <form action="{{ route('pay-khalti',request()->getQueryString()) }}" method="POST" class="needs-validation" id="khalti-form">
                                        <input type="hidden" value="{{ csrf_token() }}" name="_token"/>
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="100"
                                                 src="{{asset('public/assets/admin/img/khalti.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
