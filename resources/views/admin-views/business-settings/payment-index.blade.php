        ...
        <div class="row pb-3">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body p-30px">
                        <h5 class="text-uppercase mb-3">{{translate('messages.payment')}} {{translate('messages.method')}}</h5>
                        @php($qr_payment=\App\CentralLogics\Helpers::get_business_settings('qr_payment'))
                        <form action="{{route('admin.business-settings.payment-method-update',['qr_payment'])}}"
                              method="post">
                            @csrf
                                <div class="form-group mb-2">
                                    <label class="form-label text-capitalize text--title">
                                ...
                                <div class="d-flex flex-wrap p-0">
                                    <label class="form-check form--check mr-2 mr-md-4">
                                    <input type="radio" class="form-check-input qr_code_payment" name="status" value="1" {{$qr_payment?($qr_payment['status']==1?'checked':''):''}}>
                                        <span class="form-check-label text--title pl-2">
                                            {{translate('messages.active')}}
                                        </span>
                                    </label>
                                    <label class="form-check form--check mr-2 mr-md-4">
                                    <input type="radio" class="form-check-input digital_payment" name="status" value="0" {{$qr_payment?($qr_payment['status']==0?'checked':''):''}}>
                                        <span class="form-check-label text--title pl-2">
                                            {{translate('messages.inactive')}}
                                        </span>
                                    </label>
                ...
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <h5 class="d-flex flex-wrap justify-content-between">
                            <strong>{{translate('messages.khalti')}}</strong>
                        ...
                        <div class="payment--gateway-img">
                            <img src="{{asset('public/assets/admin/img/khalti.png')}}" alt="public">
                        </div>
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" placeholder="Khalti Secret" name="khalti_secret"
                                           value="{{env('APP_MODE')!='demo'?($config?$config['khalti_secret']:''):''}}">
                            </div>
                            <strong>{{__('Sandbox')}}</strong>
                            <label class="switch--custom-label toggle-switch toggle-switch-sm d-inline-flex">
                                <span class="mr-2 switch--custom-label-text text-primary on text-uppercase">{{ translate('messages.on') }}</span>
                                <span class="mr-2 switch--custom-label-text off text-uppercase">{{ translate('messages.off') }}</span>
                                <input type="checkbox" class="toggle-switch-input" name="is_sandbox" value="1" {{$config?((array_key_exists('is_sandbox',$config)&&$config['is_sandbox'])==1?'checked':''):''}}>
                                <span class="toggle-switch-label text">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
                ...
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <form
                            ...
                            @csrf
                        <h5 class="d-flex flex-wrap justify-content-between">
                            <strong>{{translate('messages.esewa')}}</strong>
                            <label class="switch--custom-label toggle-switch toggle-switch-sm d-inline-flex">
                                <span class="mr-2 switch--custom-label-text text-primary on text-uppercase">{{ translate('messages.on') }}</span>
                                <span class="mr-2 switch--custom-label-text off text-uppercase">{{ translate('messages.off') }}</span>
                                <input type="checkbox" class="toggle-switch-input" name="status" value="1" {{$config?($config['status']==1?'checked':''):''}}>
                        ...
                        <div class="payment--gateway-img">
                            <img src="{{asset('public/assets/admin/img/esewa.png')}}" alt="public">
                        </div>
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" placeholder="Esewa Merchant Code" name="esewa_merchant_code"
                                           value="{{env('APP_MODE')!='demo'?($config?$config['esewa_merchant_code']:''):''}}">
                            </div>
                            <strong>{{__('Sandbox')}}</strong>
                            <label class="switch--custom-label toggle-switch toggle-switch-sm d-inline-flex">
                                <span class="mr-2 switch--custom-label-text text-primary on text-uppercase">{{ translate('messages.on') }}</span>
                                <span class="mr-2 switch--custom-label-text off text-uppercase">{{ translate('messages.off') }}</span>
                                <input type="checkbox" class="toggle-switch-input" name="is_sandbox" value="1" {{$config?($config['is_sandbox']==1?'checked':''):''}}>
                                <span class="toggle-switch-label text">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
